...
คำถามค้าง (รอ Founder):
1. `HomePopCard` เอาด้วยไหม (ติดกติกา "ห้ามแก้ไฟล์ Pop โดยตรง" แต่ถ้าไม่แก้ ฟีดจะมีการ์ด 2 สไตล์ปนกัน)
2. ทรงหัวใจ A/B/C (ไม่ block งานจัดแนว แยกทำทีหลังได้)
