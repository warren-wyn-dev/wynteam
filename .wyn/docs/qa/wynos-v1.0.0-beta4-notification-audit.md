...
| K-5 | ไม่มี UI ให้ "ปิด push" หลังเปิดแล้ว | ต่ำ | ไม่มีแอปไหนปิด OS permission ของตัวเองได้ — แถวในตั้งค่าแสดงสถานะและชี้ไปที่การตั้งค่าระบบ ส่วนการปิดรายหมวดทำได้ด้วย 7 สวิตช์ที่มีอยู่แล้ว |
