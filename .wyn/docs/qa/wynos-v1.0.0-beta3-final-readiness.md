...
| 9 | โพสต์หลายรูปบน Profile / Search / hashtag / Draft ยังยิง request รูปทีละการ์ด (N+1 ที่เอาออกจาก Home ไปแล้ว) — ตอนนี้ batch ทั้งหน้าเหมือนกัน (คำสั่ง Founder "โปรไฟล์ ก็ต้องคล้ายฟีด") | 9, 25 |
...
| 3 | รูปเรียงกันเป็นการ์ด รูปที่ 2 โผล่นิดเดียว (คำสั่ง 2026-09-03) | ✅ **ทำแล้ว** — Feed และ Post Detail ใช้ `PostImageCarousel` ตัวเดียวกัน |
| 3 | snap ทีละการ์ด (คำสั่ง 2026-09-03) | ✅ **ทำแล้ว** — `_CardSnapPhysics` ใช้กับทั้งสองหน้า |
| 15 | โปรไฟล์ต้องคล้ายฟีด (คำสั่ง 2026-09-03) | ✅ **หน้าตาเหมือนอยู่แล้ว** (AI รายงานผิดรอบแรก แก้แล้ว) · **พฤติกรรมแก้แล้ว** — batch รูปทั้งหน้าเหมือน Home |
| — | Grid ที่เหลือ (Search แท็บโพสต์ · Saved · Draft) | ✅ **คงไว้** ตามที่ Founder ยืนยัน 2026-09-03 — ไม่แตะ |
...
| Request รูป ต่อ 1 หน้า **Profile / Search / hashtag / Draft** | 8 | 1 | **−87.5%** |
...
| `flutter test` | ✅ **1,107 ผ่านทั้งหมด** (baseline 1,086 + **21 test ใหม่**) |
...
**โพสต์หลายรูปบนโปรไฟล์ไม่ยิง request รูปของตัวเอง**
...
|---|---|---|
| **D-1** | **รูปที่ 2 โผล่เท่านี้พอไหม** | การ์ดกว้าง 82% ของแถว → บนจอ 390pt รูปที่ 2 โผล่ราว 62pt ถ้าอยากให้โผล่น้อยกว่านี้ บอกตัวเลขได้ — ปรับที่ `postCardWidthFraction` ค่าเดียว เปลี่ยนพร้อมกันทั้ง Feed และ Detail · **ข้อเดียวที่ยังค้างจากชุดคำสั่ง 2026-09-03** |
