...
- **Current Features**: WYN-002 (Authentication & Onboarding) — QA รอบ 2 **FAIL อีกครั้ง** พบ regression ใหม่ที่เกิดจากการแก้บั๊ก Critical ของรอบ 1 เอง (ผู้ใช้ใหม่ที่ผ่าน username setup แล้ว logout ไม่ได้ ต้อง force-restart แอป) — ดู `.wyn/tasks/bugs/WYN-002-authentication-onboarding.md` ห้ามถือว่าใช้งานได้จนกว่า QA จะ PASS
