...
- **Future Features**: WYN-004 (Feed & Post — global feed, สร้างโพสต์ข้อความ+รูป, Like, Comment, ลบโพสต์ตัวเอง) **AI Coding เสร็จแล้ว** (`flutter analyze`/`flutter test` ผ่าน 35/35 รวม test ใหม่, พบและแก้บั๊ก layout overflow เชิงป้องกันก่อนส่ง QA) รอ AI QA & Security — ดู `.wyn/tasks/review/WYN-004-feed-and-post.md` และ `.wyn/docs/design/wyn-004-feed-and-post.md`
