...
- **Product Direction — กำลังเปลี่ยน (2026-08-14)**: Founder ส่ง spec ใหม่ "WYN V0.1 — CORE APP FEATURE PROMPT" แทนที่ทิศทางเดิมทั้งหมด — โครงสร้างใหม่คือ Bottom Nav 4 เมนู Home (Search+Feed รวม)/Drop (โพสต์รูปภาพ)/Pop (โพสต์คลิปสั้นแนวตั้ง)/Profile พร้อม Like/Comment/Share/Save/Follow/Notification เต็มรูปแบบ — ดูรายละเอียดเต็มที่ `.wyn/company/DECISIONS.md` (2026-08-14) WYN-002/WYN-003 ยังใช้เป็นฐานได้ (Auth/Profile ตรงกับ spec ใหม่) แต่ WYN-004 (Feed & Post แบบรวม) จะถูกแทนที่ด้วย Drop+Pop แยกกันตาม spec ใหม่ — รอเริ่ม `/product` รอบใหม่
