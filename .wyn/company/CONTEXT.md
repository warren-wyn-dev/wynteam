...
- **Future Features**: WYN-004 (Feed & Post — global feed, สร้างโพสต์ข้อความ+รูป, Like, Comment, ลบโพสต์ตัวเอง) **QA รอบ 1 — FAIL** (Major: กด Like หรือปุ่ม "โพสต์" ซ้ำเร็ว ๆ ก่อนหน้าจอ rebuild ทำให้ state ไม่ตรงกับ DB / เสี่ยงสร้างโพสต์ซ้ำ) รอ AI Debug Engineer — ดู `.wyn/tasks/bugs/WYN-004-feed-and-post.md` และ `.wyn/docs/design/wyn-004-feed-and-post.md`
