...
- **Future Features**: WYN-004 (Feed & Post — global feed, สร้างโพสต์ข้อความ+รูป, Like, Comment, ลบโพสต์ตัวเอง) อยู่ใน backlog รอ AI Design — ดู `.wyn/tasks/backlog/WYN-004-feed-and-post.md`
