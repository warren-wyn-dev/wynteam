...
- **Future Features**: WYN-003 (User Profile — view/edit display name, bio, avatar) โค้ดเขียนแล้ว ผ่าน `flutter analyze`/`flutter test` (12/12) รอ AI QA & Security — ดู `.wyn/tasks/review/WYN-003-user-profile.md`
