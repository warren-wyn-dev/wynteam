...
- **Future Features**: WYN-003 (User Profile) — QA รอบ 1 **FAIL** พบบั๊ก Critical (บันทึกโปรไฟล์ล้มเหลวถ้าไม่ได้กรอกชื่อแสดง — ค่าเริ่มต้นของผู้ใช้ทุกคน เพราะ empty string ขัดกับ DB constraint) — ดู `.wyn/tasks/bugs/WYN-003-user-profile.md` ห้ามถือว่าใช้งานได้จนกว่า QA จะ PASS
