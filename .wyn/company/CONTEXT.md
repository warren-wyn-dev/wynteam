...
- **Future Features**: WYN-003 (User Profile — view/edit display name, bio, avatar) อยู่ใน backlog รอ AI Design ออกแบบ — ดู `.wyn/tasks/backlog/WYN-003-user-profile.md`
