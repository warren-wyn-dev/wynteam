...
- **Future Features**: WYN-003 (User Profile — view/edit display name, bio, avatar) ออกแบบเสร็จแล้ว รอ AI Coding — ดู `.wyn/tasks/active/WYN-003-user-profile.md` และ `.wyn/docs/design/wyn-003-user-profile.md`
