...
- **Future Features**: WYN-004 (Feed & Post — global feed, สร้างโพสต์ข้อความ+รูป, Like, Comment, ลบโพสต์ตัวเอง) ออกแบบเสร็จแล้ว รอ AI Coding — ดู `.wyn/tasks/active/WYN-004-feed-and-post.md` และ `.wyn/docs/design/wyn-004-feed-and-post.md`
