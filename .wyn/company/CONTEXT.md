...
- **Future Features**: WYN-004 (Feed & Post — global feed, สร้างโพสต์ข้อความ+รูป, Like, Comment, ลบโพสต์ตัวเอง) **Debug เสร็จแล้ว** (แก้บั๊ก double-tap ของ Like/Create Post ครบ 2 จุด มี regression test คุ้มครองจริงแบบ dynamic, `flutter analyze`/`flutter test` ผ่าน 37/37) รอ AI QA & Security รอบ 2 — ดู `.wyn/tasks/bugs/WYN-004-feed-and-post.md` และ `.wyn/docs/design/wyn-004-feed-and-post.md`
