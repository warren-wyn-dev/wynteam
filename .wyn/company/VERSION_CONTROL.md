...
รายละเอียดของ v1.0.0 Beta1 (ฟีเจอร์ที่ใช้งานได้ตอนนั้น, ลิงก์ใช้งานจริง, สิ่งที่ยังไม่รวม) ดู historical snapshot ใน `RELEASE_NOTES.md` ส่วนสถานะ release ปัจจุบันในไฟล์นั้นอัปเดตเป็น **WYNOS v1.0.0 Beta4** แล้วเมื่อ 2026-09-08 ให้ตรงกับ baseline ในเอกสารนี้
