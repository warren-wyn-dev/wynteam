#!/usr/bin/env bash
# QA regression test for WYN-138 (DM Edit + Pin Message) -- written
...
#
# Usage: bash supabase/tests/wyn_138_dm_message_edit_pin_test.sh
set -euo pipefail

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
SCHEMA_FILE="$SCRIPT_DIR/../schema.sql"
DB_NAME="wyn138_qa_test"
WORK_DIR="$(mktemp -d)"
...
echo "== Seeding fixtures and running RLS/RPC checks (WYN-138) =="
