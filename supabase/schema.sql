...
-- WYN-149 / BUG-003: atomic LocationIQ rate-limit reservation.
...
-- WYN-186: Quote interactions (applied independently in production via the
-- migrations_wyn186_quote_interactions.sql file; included here for local
-- from-scratch schema regression tests).
