...
handler_replacement = r'''  Future<void> _handleIncomingRealtimeDm({
    ...
    // The profile lookup above is asynchronous. Re-check the account and active
    // conversation after it completes so a fast account/route switch cannot
    // surface a stale DM banner.
...
banner_replacement = r'''  void _showForegroundMessage({
