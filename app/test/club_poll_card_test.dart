...
import 'package:wyn/features/club/presentation/widgets/club_poll_card.dart';

Widget _wrap(Widget child) => MaterialApp(home: Scaffold(body: child));

/// Mirrors test/poll_card_test.dart (Drop's own Poll widget, WYN-035) --
/// ClubPollCard (WYN-115) copies PollCard's behavior almost verbatim.
void main() {
  ...
  testWidgets('results hidden (not voted, not author, still open) shows '
    ...
    await tester.pumpWidget(_wrap(ClubPollCard(
      options: options,
      expiresAt: future,
      myVoteIndex: null,
      totalVotes: null,
