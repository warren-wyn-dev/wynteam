...
import { Bookmark, Eye, Flag, Heart, MessageCircle, MoreHorizontal, Quote, Repeat2, Send, Share2, X } from "lucide-react";
...
function Avatar({ src, label }: { src?: string | null; label: string }) {
  ...
  return <img className="golden-drop-avatar" src={src} alt="" onError={() => setFailed(true)} />;
}
