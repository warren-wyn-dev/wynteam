...
import { BarChart3,Bell,Camera,ChevronLeft,Heart,House,Image as ImageIcon,Link2,MapPin,Menu,MessageCircle,MoreHorizontal,Plus,Repeat2,Search,UserPlus,UserRound,UsersRound,X } from "lucide-react";
const iconMap={back:ChevronLeft,camera:Camera,chat:MessageCircle,club:UsersRound,close:X,comment:MessageCircle,home:House,image:ImageIcon,like:Heart,link:Link2,location:MapPin,menu:Menu,more:MoreHorizontal,notifications:Bell,poll:BarChart3,post:Plus,profile:UserRound,repost:Repeat2,search:Search,userPlus:UserPlus} as const;
