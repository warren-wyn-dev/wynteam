...
/// supabase/schema.sql, WYN-016 section). Duplicated from `app/`'s
/// identical file -- same reasoning as every other cross-app duplicate
/// in this project (no shared package, see .wyn/company/DECISIONS.md).
