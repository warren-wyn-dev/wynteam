...
import 'package:zoky_seller/features/auth/presentation/widgets/otp_box_input.dart';

/// Ported verbatim from `app/test/otp_box_input_test.dart` -- the
/// widget itself was ported unchanged too (see .wyn/tasks/backlog/
/// SELLER-001-foundation.md).
void main() {
